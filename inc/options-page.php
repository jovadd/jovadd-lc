	...
	<div class="pico-wrap">
        ...
        <div class="pico-welcome-panel">
            ...
            <div class="pico-welcome-panel-content">
                ...
                <h2 style="float:right" > jovadd-lc v<?php echo pico_get_parent_theme_version() ?></h2>
                ...
                <p>Learn more at  
                    <a  target="_blank" href="https://jovadd-lc.com/" class="">                                        
                        <span> jovadd-lc.com</span>
                            <svg   width="12" height="12" xmlns="http://www.w3.org/2000/svg"  fill="currentColor" viewBox="0 0 16 16" style="" lc-helper="svg-icon">
                ...
                <div class="pico-container">
					...
					<div class="pico-column" style="width:55%;">
                            ...
                            <h3>Get Started</h3>
                            <a class="button button-hero" target="_blank" href="https://jovadd-lc.com/docs/">Theme Documentation</a>
							<br><br>
		...
		<div class="metabox-holder">
			<div class="postbox" style="padding: 0 10px;"> 
				...
				if (  get_template_directory() === get_stylesheet_directory()) {
					echo '
					<h2>Please do not edit directly the jovadd-lc theme folder. </h2>
					
					<p>To add your own [SASSy] CSS code, you need to enable a child theme. Download our child theme starter for free at <a target="_new" href="https://jovadd-lc.com/#downloads">jovadd-lc.com</a>. </p>
					...
					<p>Open this file with your favourite text editor, save. Then, launch the SASS compiler clicking the SASS logo in the WordPress Top Bar. <br>
